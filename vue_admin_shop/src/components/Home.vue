      ...
      <el-col :span="24" class="main">
        <el-menu default-active="1-4-1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" :collapse="collapsed">
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              <el-menu-item index="1-1" @click="pushTable()">商品列表</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="2">
            <template slot="title">
              ...
              <el-menu-item index="2-4" @click="pushUser()">用户列表</el-menu-item>
          </el-submenu>
           <el-submenu index="3">
            <template slot="title">
            ...
            <el-menu-item-group>
              <el-menu-item index="1-2" @click="pushForm()">订单列表</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
        </el-menu>
