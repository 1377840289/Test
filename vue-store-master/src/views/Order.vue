      ...
      <div class="content" v-for="(item,index) in orders" :key="index">
        <ul>
          ...
          <li class="order-info">
            ...
            <div class="order-time">订单时间: {{item.creattime}}</div>
          </li>
          <li class="header">
          ...
          <!-- 订单列表 -->
          <li class="product-list" v-for="(product,i) in item.orderDetail" :key="i">
            <div class="pro-img">
            ...
            <div class="pro-price">{{product.score}}元</div>
            <div class="pro-num">{{product.number}}</div>
            <div class="pro-total pro-total-in">{{product.score*product.number}}元</div>
          </li>
        </ul>
        <div class="order-bar">
          <div class="order-bar-left">
            <span class="order-total">
              共
              <span class="order-total-num">{{item.orderDetail.length}}</span> 件商品
            </span>
          </div>
